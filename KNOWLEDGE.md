...
**Design DNA — `dashboard` / dark / Dark-themed cloud-platform aesthetic with modular grids, glass-like panels, and strong data hierarchy for productivity dashboards.**
- Layout family: `marquee-band` — A full-width colour or media band resets the rhythm, then the verb.
- Density: airy. Dark-tech: void surfaces, one glow or jewel, sparse chrome.
...
- Type: Tabular figures, no display face, hairline rules. Reference type feel: dark.
- Execute: Dark-tech: void surfaces, one glow or jewel, sparse chrome. Layout `marquee-band`, density airy. Kit 24/10, shadow, bordered prominent. Palette recipe `mid`. Almost no travel. Cross-fade 180ms ease-out. Numbers tick, they do not fly. Reduce Motion: instant swap. Reduce Motion: fade only. Do not invent a second radius or a second accent.
...
- Invariant (unit-test this): Vanilla search→queue→seen→rate is a 10-app clone. Pick one rare verb and persist it on home.
- Empty: Nothing in the pile.
- Fake that fails: Queue/Seen rename or a new poster style.
